...
def app():
    ...
    with st.container():
        ...
        | **Focus Strategy on Customer Behavior**            | - Since certain demographic features show minimal or negative impact, strategies should focus on customer behavior patterns.<br> - Prioritize customer interaction and engagement over demographic data.                                                    |
        """, unsafe_allow_html=True)