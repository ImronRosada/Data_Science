...
def app():
    ...
    with st.container():
        ...
        | **Focus Strategy on Customer Behavior**            | - Since some demographic features like **income and education** have minimal or negative impact on churn, it's more effective to focus on behavioral patterns and strengthen customer engagement for better retention.                                      |
        """, unsafe_allow_html=True)